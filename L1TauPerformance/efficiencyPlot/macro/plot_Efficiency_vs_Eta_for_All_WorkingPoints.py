...
fileName_In = "/home/sbhowmik/L1TauTrigger/L1TauStudy/L1TauStudy/L1TauPerformance/efficiencyPlot/results/fitOutput_Efficiency_vs_Eta_for_data_Run2018_20210715.root"
fileName_Out = "/home/sbhowmik/L1TauTrigger/L1TauStudy/L1TauStudy/L1TauPerformance/efficiencyPlot/plots/plot_Efficiency_vs_Eta_for_data_Run2018_All_WorkingPoints_20210715"
...
for i in range (0, len(isoTypes)):
    for j in range (0, len(plotRanges)):
        ...
        for k in range (0, len(workingPointNames)):
            ...
            plots[-1].extraText1 = "Offline #tau_{h} p_{T} > 40 GeV" 
            plots[-1].extraText2 = ""
            plots[-1].extraText3 = ""
            plots[-1].extraText4 = ""
            plots[-1].extraText5 = ""
            ...
            plots[-1].xRange = (-plotRanges[j], plotRanges[j])
            plots[-1].xTitle = "Offline #tau_{h} #eta"
