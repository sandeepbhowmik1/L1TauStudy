...
fileName_Out = "/home/sbhowmik/L1TauTrigger_NTuple/Performance_2018data_181128/NTuple_SingleMu_Run2018_total_forResolution_181128.root"
...
for ev in range (0, nentries):
    ...
    if abs(treeIn.tauPt) < ptMin:
    #if abs(treeIn.recoTauPt) < ptMin:
        continue
